                ...
                <div key={activeDeskTab} className="flex flex-1 flex-col min-w-0 overflow-y-auto px-6 py-6 animate-in fade-in-0 duration-200">
                  <div className="w-full max-w-[1200px] mx-auto lyra-container-grid-wrap">
                    {showPageHeader && (
                      ...
                      child. Title/subtitle/actions content (Personal Queue chip +
                      tri-state agent-leg indicator) is unchanged from the `PageHeader`
                      version, just re-hosted in a plain div approximating that
                      component's own plain-title layout (`lyra-heading-lg` title,
                      `lyra-body-sm text-lyra-fg-secondary` subtitle, right-aligned
                      actions) since it no longer needs `PageHeader`'s pinned/bordered
                      "record header" semantics. */
