...
<div key="dashboard" className="flex flex-1 flex-col min-w-0 overflow-hidden animate-in fade-in-0 duration-200">
                  {showPageHeader && (
                    ...
                    // changed from "Agent ID:" to "User Name:" (that
                    // subhead is gone now too, removed per a later
                    // explicit request). The Personal Queue chip that used
                    // to float in `actions` here has moved to
                    // `homeContent.titleBadge` instead, inline right after
                    // "Home" — see that doc comment, above.
                    <>
                    <PageHeader
